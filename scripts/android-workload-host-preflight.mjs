...
const checks = [
  {
    key: "kvm_device",
    passed: facts.kvm_device === "true",
    detail: "/dev/kvm exposed to workload host"
  },
  {
    key: "binder_or_binderfs",
    passed: facts.binder_device === "true" || Number(facts.binderfs_mount || 0) > 0,
    detail: "binder/binderfs exposed to Android runtime"
  },
  {
    key: "not_unqualified_nested_cloud_vps",
    passed: facts.virtualization === "none" || facts.kvm_device === "true",
    detail: "host is bare metal or nested KVM is exposed"
  }
];
