# SYLION Admin Panel V2 Step 3.2 - Mermaid Diagrams

Ten plik zbiera diagramy Step 3.2 w jednym miejscu. Te same diagramy sa zapisane jako osobne pliki `.mmd` w `docs/admin-panel-v2/diagrams/`.

## 1. Module Dependency Graph

Zrodlo: `diagrams/11-step3-2-module-dependencies.mmd`
...
Zrodlo: `diagrams/12-step3-2-module-map.mmd`
...
Zrodlo: `diagrams/13-step3-2-deployment-graph.mmd`
...
Zrodlo: `diagrams/14-step3-2-runtime-flow.mmd`
...
Zrodlo: `diagrams/15-step3-2-roadmap-gantt.mmd`
