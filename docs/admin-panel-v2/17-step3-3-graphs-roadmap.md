# SYLION Admin Panel V2 - Step 3.3 Graphs And Roadmap
...
```text
Gate 1: lockout triggers after configured failures.
Gate 2: recovery request never unlocks automatically.
Gate 3: break-glass request has humanGateRequired true and no side effect.
Gate 4: audit contains recovery/lockout/break-glass events without secrets.
Gate 5: PHANTOM v3.0 remains separated from baseline behavior.
Gate 6: docs mention Ksiega 3.4 baseline and HUMAN GATE.
