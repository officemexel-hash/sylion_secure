...
const htmlPath = path.join(
  ...
  "docs",
  "ksiega-4-0-internal",
  "KSIEGA_4_0_INTERNAL_FULL_TECHNICAL_BASELINE.html"
);
const pdfPath = path.join(
  repo,
  "docs",
  "ksiega-4-0-internal",
  "KSIEGA_4_0_INTERNAL_FULL_TECHNICAL_BASELINE.pdf"
);
const previewPath = path.join(
  repo,
  "docs",
  "ksiega-4-0-internal",
  "KSIEGA_4_0_INTERNAL_FULL_TECHNICAL_BASELINE_preview.png"
);
