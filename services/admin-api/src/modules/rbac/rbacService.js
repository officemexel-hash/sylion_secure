...
const ROLE_PERMISSIONS = Object.freeze({
  ...
  [ROLES.SECURITY_ADMIN]: [
    ...
    "operator.suspend",
    "operator.revoke",
    "operator.disposable_teardown.manage",
    ...
    "terminal.admission.evaluate",
    "cellular.inventory.read",
