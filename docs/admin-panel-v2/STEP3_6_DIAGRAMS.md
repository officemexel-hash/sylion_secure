# SYLION Admin Panel V2 Step 3.6 - Mermaid Diagrams

Ten plik zbiera diagramy Step 3.6 w jednym miejscu. Te same diagramy sa zapisane jako osobne pliki `.mmd` w `docs/admin-panel-v2/diagrams/`.

## 1. Module Dependency Graph

Zrodlo: `diagrams/32-step3-6-module-dependencies.mmd`
...
Zrodlo: `diagrams/33-step3-6-module-map.mmd`
...
Zrodlo: `diagrams/34-step3-6-deployment-graph.mmd`
...
Zrodlo: `diagrams/35-step3-6-runtime-flow.mmd`
...
Zrodlo: `diagrams/36-step3-6-gate-state-machine.mmd`
...
## 6. UI Lifecycle Graph

Zrodlo: `diagrams/37-step3-6-ui-lifecycle.mmd`
...
Zrodlo: `diagrams/38-step3-6-roadmap-gantt.mmd`
